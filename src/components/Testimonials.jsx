  ...
  return (
    ...
    transition={{ duration: 1, ease: 'easeIn' }}>
       <div className='absolute top-0 left-0 w-full h-full bg-blue-950 bg-opacity-80 shadow-lg rounded-md  text-white'></div>  
        ...
        <motion.h2 className='text-xl lg:text-3xl text-white  tracking-widest text-center uppercase'
        initial={{ y:-60,opacity: 0 }}
        whileInView={{ y:0,opacity: 1 }}
        transition={{ duration:1, ease: 'easeIn',delay:.2 }}>What Our Clients Say<span className='font-bold ml-3 text-white text-4xl'
        >&#x2192;</span> </motion.h2>
       <motion.p className='text-center text-sm lg:text-lg text-gray-300 w-3/4 mx-auto mt-3' initial={{ x:-100,opacity: 0 }}
     ...
     <motion.h3 className='text-lg md:text-2xl text-center text-white tracking-wider'initial={{ y:60,opacity: 0 }}
        whileInView={{ y:0,opacity: 1 }}
        transition={{ duration:1, ease: 'easeIn',delay:.2 }}>If you have Interested Please Feel Free To Contact Us</motion.h3>
     <Link href='/contact' >
     <button className='py-1 px-6 mt-4 rounded-lg  bg-transparent border text-white hover:bg-white hover:text-red-700'>Connect Us</button>
     </Link>
     </div>
      </div> 
      </div>
